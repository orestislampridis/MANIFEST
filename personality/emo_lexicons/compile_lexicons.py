...
# Files
OUTPUT_FILE = "emo_lexicons/lexicons/lexicons_compiled2.csv"
...
EMOLEX_FILE = "emo_lexicons/lexicons/NRC-Emotion-Lexicon-v0.92/NRC-emotion-lexicon-wordlevel-alphabetized-v0.92.txt"
match_count = 0
add_count = 0
...
print
"Emolex matches: " + str(match_count) + ", added: " + str(add_count)

# Built in extended EmoLex aka affect words
EXTENDED_EMOLEX_FILE = "emo_lexicons/lexicons/affect_words.csv"
match_count = 0
add_count = 0

with open(EXTENDED_EMOLEX_FILE, 'rb') as f:
    rows = csv.reader(f, delimiter=',')
    for _word, _emotion, in rows:
        word = {}
        word['word'] = _word.decode('utf-8').lower()
        word['source'] = 'extended_emolex'
        if _emotion in categories['emotion']:
            word['emotion'] = _emotion
            add_word(word)
print
"Extended Emolex matches: " + str(match_count) + ", added: " + str(add_count)

# Bing Liu's Opinion Lexicon: http://www.cs.uic.edu/~liub/FBS/sentiment-analysis.html#lexicon
OPINION_LEX_NEG_FILE = "emo_lexicons/lexicons/opinion-lexicon-English/negative-words.txt"
OPINION_LEX_POS_FILE = "emo_lexicons/lexicons/opinion-lexicon-English/positive-words.txt"
match_count = 0
add_count = 0
...
print
"Opinion Lexicon matches: " + str(match_count) + ", added: " + str(add_count)
...
MPQA_FILE = "emo_lexicons/lexicons/subjectivity_clues_hltemnlp05/subjclueslen1-HLTEMNLP05.tff"
match_count = 0
add_count = 0
...
with open(MPQA_FILE) as f:
    ...
    for line in lines:
        ...
        if word['word'] and ('subjectivity' in word or 'sentiment' in word):
            ...
            print
            "MPQA warning: no match for " + word['word']

print
"MPQA matches: " + str(match_count) + ", added: " + str(add_count)
...
INQUIRER_FILE = "emo_lexicons/lexicons/inquirerbasic.csv"
match_count = 0
add_count = 0
...
print
"Inquirer matches: " + str(match_count) + ", added: " + str(add_count)
...
COLOR_FILE = "emo_lexicons/lexicons/NRC-Colour-Lexicon-v0.92/NRC-color-lexicon-senselevel-v0.92.txt"
match_count = 0
add_count = 0
...
print
"Colour matches: " + str(match_count) + ", added: " + str(add_count)
...
for ch in category_headers:
    ...
    print
    "Words with " + ch + ": " + str(words_with_category) + " (" + str(
        round(1.0 * words_with_category / word_count * 100, 1)) + "%)"
